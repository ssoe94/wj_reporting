...
품질률: 양품수 / 실제 생산수`,
    ...
    'setup.history_return_button': '셋업현황 보기',
    ...
    'quality.report_dt_required': '보고일시를 선택하세요',
    ...
    'quality.show_similar_parts': '유사모델 보기 (Part No. 앞 9자리 기준)',
    'quality.section': '보고부문',
    'quality.lot_size': 'LOT SIZE',
    'quality.defect_rate': '불량률',
    'quality.judgement': '판정결과',
    'quality.prev_page': '이전',
    'quality.next_page': '다음',
    'quality.report_datetime': '보고일시',
    ...
    'quality.disposition': '처리방식',
    'quality.disposition_placeholder': '재작업 후 사용 필요',
    'quality.add_part_required_fields': '필수: Part No / Model Code / Description',
    'quality.model_code': 'Model Code',
    'quality.part_model_desc_required': 'Part No / Model Code / Description을 입력하세요',
    ...
    'quality.production_line': '생산라인',
    'quality.select_line': '라인 선택',
    'quality.supplier': '공급업체',
    'quality.supplier_placeholder': '공급업체 입력 또는 선택',
    'quality.production_date': '생산일자',
    'quality.image_max_warning': '최대 3장까지 업로드 가능합니다',
    'quality.phenomenon_placeholder': '불량 현상을 상세히 입력하세요',
    'quality.image_add': '이미지 추가',
    'quality.image_max_info': '최대 3장까지 업로드 가능',
    'quality.image_drag_drop': '이미지를 드래그하거나 클릭하여 업로드하세요',
  },
  zh: {
    title: '万佳生产数据管理平台',
    modelsTitle: '型号管理',
...
品质率：良品数 / 实际产量`,
    ...
    analysis_tablist_label: '生产力分析选项卡',
    analysis_tab_injection: '注塑生产',
    analysis_tab_assembly: '加工生产',
    analysis_assembly_title: '加工生产力分析',
    analysis_assembly_desc: '基于加工生产与品质数据提供关键指标。',
    ...
    analysis_metric_uph: 'UPH',
    analysis_metric_upph: 'UPPH',
    analysis_metric_per_hour: '/小时',
    analysis_metric_per_person_hour: '/人·小时',
    analysis_metric_trend_title: '生产实绩与品质趋势',
    analysis_chart_plan: '计划数量',
    analysis_chart_actual: '实绩数量',
    analysis_defect_title: '不良类型现状',
    analysis_defect_no_data: '暂无不良数据。',
    analysis_defect_processing: '加工不良',
    analysis_defect_outsourcing: '外协不良',
    analysis_defect_injection: '注塑不良',
    analysis_defect_total: '不良合计',
    analysis_defect_detail_title: '不良明细分析',
    analysis_defect_detail_hint: '查看各类别下的详细不良构成',
