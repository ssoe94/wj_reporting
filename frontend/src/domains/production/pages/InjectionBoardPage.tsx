...
export function InjectionBoardPage() {
  ...
  function openPreviousSummary() {
    setIsPreviousSummaryOpen(true);
    if (previousPlanQuery.isError) void previousPlanQuery.refetch();
    if (previousStatusQuery.isError) void previousStatusQuery.refetch();
    if (previousMesQuery.isError) void previousMesQuery.refetch();
  }
